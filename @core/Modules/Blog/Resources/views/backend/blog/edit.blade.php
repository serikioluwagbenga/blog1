                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <label for="breaking_news"><strong>{{__('Comment Show')}}</strong></label>
                                            <label class="switch">
                                                <input type="checkbox" name="comment_status" @if ($blog_post->comment_status ?? '') checked  @endif >
    ...
    <script>
        (function ($) {
            ...
            if($('#status').val() == 'schedule') {
                ...
                var url = `{{url('/'.get_page_slug(get_static_option('blog_page'),'blog').'/')}}/` + sl;
