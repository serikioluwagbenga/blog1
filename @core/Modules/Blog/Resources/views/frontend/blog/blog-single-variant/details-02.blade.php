        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="blog-details-inner-area">
                    @include('frontend.pages.blog-single-two-portions.title-part')
                    @include('frontend.pages.blog-single-two-portions.image-and-gallery')
                    @include('frontend.pages.blog-single-two-portions.description-others')
                    @include('frontend.pages.blog-single-two-portions.related-blogs')
                </div>
                @if(!empty($blog_post->comment_status))
                    @include('frontend.pages.blog-single-two-portions.comment-area')
                 @endif
            </div>
