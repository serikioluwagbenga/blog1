...
class UserPostController extends Controller
{
    ...
    {
        $all_comments = Blog::find($id);
        return view(self::BASE_PATH.'comment',compact('all_comments'));
    }

    public function user_blog_comment_approve($id)
    {
    ...
    public function user_blog_comment_delete(Request $request,$id){
