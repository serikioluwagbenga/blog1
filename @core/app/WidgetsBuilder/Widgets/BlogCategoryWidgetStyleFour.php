...
class BlogCategoryWidgetStyleFour extends WidgetBase
{
 ...
 $category_markup.= <<<LIST
    <li class="single-item">
        <a href="{$url}" class="wrap">
            ...
            <span class="right-content">{$title} <span class="count">({$bol}) Articles</span></span>
        </a>
    </li>
...
LIST;
 ...
 return <<<HTML
    ...
    <div class="widget">
        <div class="category style-02 v-02 radius">
