...
@section('page-title')
    ...
    <li class="list-item"><a href="#">{{__('All Post')}}</a></li>
@endsection
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   ...
                                                   @if(!empty($data->comment_status))
                                                    <a class="btn btn-warning btn-xs mb-3 mr-1" target="_blank" href="{{route('user.blog.comments',$data->id)}}">
                                                       {{__('View Comments')}} ({{count($data->comments)}})
                                                    </a>
                                                    @endif
                                                </td>
                                            </tr>
