...
<ul class="comment-list">
 <?php $__currentLoopData = $blogComments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    ?>
<?php if($data->comment_approve_status == 1): ?>
    <li>
        <div class="single-comment-wrap">
            ...
            <div class="content">
                    ...
                    <div class="left">
                        ...
                        <ul class="post-meta">
                            <li class="meta-item comment-date">
                               ...
                               <?php echo e(optional($data->created_at)->format('d-m-Y')); ?>
                ...
                <p class="comment common-para"><?php echo $data->comment_content ?? ''; ?></p>
    ...
    <?php if($repData->comment_approve_status == 1): ?>
            <li>
                <div class="single-comment-wrap">
                    <div class="thumb">
...
<?php /**PATH /Users/xgenious/Desktop/xgenious/localhost/katerio-last-server-file/@core/resources/views/frontend/partials/pages-portion/comment-show-data.blade.php ENDPATH**/ ?>