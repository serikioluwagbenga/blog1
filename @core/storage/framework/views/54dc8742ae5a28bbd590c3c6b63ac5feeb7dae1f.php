...
<?php endif; ?>
                            <div class="tab-content margin-top-30" id="nav-tabContent">
                                <?php $__currentLoopData = $all_languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tab-pane fade <?php if($key == 0): ?> show active <?php endif; ?>" id="nav-home-<?php echo e($lang->slug); ?>" role="tabpanel" aria-labelledby="nav-home-tab">
                                        ...
                                        <div class="form-group">
                                            <label for="site_<?php echo e($lang->slug); ?>_title"><?php echo e(__('Left Bar Blog Title')); ?></label>
                                            <input type="text" name="leftbar_blog_<?php echo e($lang->slug); ?>_title"  class="form-control" value="<?php echo e(get_static_option('leftbar_blog_'.$lang->slug.'_title')); ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="site_<?php echo e($lang->slug); ?>_tag_line"><?php echo e(__('Left Bar Tag Title')); ?></label>
                                        ...
                                        <div class="form-group">
                                            <label for="site_<?php echo e($lang->slug); ?>_title"><?php echo e(__('Left Bar Social Title')); ?></label>
                            ...
                            <div class="form-group">
                                <label ><?php echo e(__('Blog Item Show')); ?></label>
                                <input type="number" name="leftbar_blog_item_show"  class="form-control" value="<?php echo e(get_static_option('leftbar_blog_item_show')); ?>">
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/katerio/@core/resources/views/backend/pages/leftbar-settings.blade.php ENDPATH**/ ?>