...
<?php $__env->startSection('page-title'); ?>
    <li class="list-item"><a href="#"><?php echo e(__('User Blog')); ?></a></li>
    <li class="list-item"><a href="#"><?php echo e($user_info->name); ?> </a></li>
<?php $__env->stopSection(); ?>
            ...
            <div class="col-lg-12">
                <div class="author-profile">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="content">
                                <h4 class="title"><?php echo e($user_info->name); ?></h4>
                                <p class="designation"><?php echo e($user_info->designation); ?></p>

                                <p class="info"><?php echo $user_info->description; ?></p>
                                        ...
                                        <div class="social-link style-04 v-02">
                                            <ul class="widget-social-link-list">
                                                <li class="single-item">
                                                    <a href="<?php echo e($user_info->facebook_url); ?>" class="left-content">
                                                ...
                                                <li class="single-item">
                                                    <a href="<?php echo e($user_info->twitter_url); ?>" class="left-content">
                                                ...
                                                <li class="single-item">
                                                    <a href="<?php echo e($user_info->instagram_url); ?>" class="left-content">
                                                ...
                                                <li class="single-item">
                                                    <a href="<?php echo e($user_info->linkedin_url); ?>" class="left-content">
    ...
    <div class="container">
        ...
        <div class="row three-column">
            <?php if(count($all_blogs) < 1): ?>
                <div class="col-md-12">
                    <span class="text-dark"><?php echo __('No post found related to : ').' '. '<span class="text-warning"> '.$user_info->name.' </span>'; ?></span>
                </div>
        </div>
        <?php else: ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/katerio/@core/Modules/Blog/Resources/views/frontend/blog/user-blog.blade.php ENDPATH**/ ?>